...
define('minnpost-metro-parcels', [
  ...
  _.extend(App.prototype, {
    ...
    // Default options
    defaultOptions: {
      projectName: 'minnpost-metro-parcels',
      remoteProxy: null,
      el: '.minnpost-metro-parcels-container',
      ...
      availablePaths: {
        ...
        build: {
          css: [
            ...
            'dist/minnpost-metro-parcels.libs.min.css',
            'dist/minnpost-metro-parcels.latest.min.css'
          ],
          ie: [
            'dist/minnpost-metro-parcels.libs.min.ie.css',
            'dist/minnpost-metro-parcels.latest.min.ie.css'
          ],
          images: 'dist/images/',
          data: 'dist/data/'
        },
        deploy: {
          css: [
            '//netdna.bootstrapcdn.com/font-awesome/4.0.3/css/font-awesome.css',  'https://s3.amazonaws.com/data.minnpost/projects/minnpost-metro-parcels/minnpost-metro-parcels.libs.min.css',
            'https://s3.amazonaws.com/data.minnpost/projects/minnpost-metro-parcels/minnpost-metro-parcels.latest.min.css'
          ],
          ie: [  'https://s3.amazonaws.com/data.minnpost/projects/minnpost-metro-parcels/minnpost-metro-parcels.libs.min.ie.css',
            'https://s3.amazonaws.com/data.minnpost/projects/minnpost-metro-parcels/minnpost-metro-parcels.latest.min.ie.css'
          ],
          images: 'https://s3.amazonaws.com/data.minnpost/projects/minnpost-metro-parcels/images/',
          data: 'https://s3.amazonaws.com/data.minnpost/projects/minnpost-metro-parcels/data/'
        }
      }
    },
 ...
 * Run application
 */
require(['jquery', 'minnpost-metro-parcels'], function($, App) {
